    ...
    return (
        <Link
            ...
            className={`w-full flex items-start ps-3 pe-4 py-2 border-l-4 ${
                active
                    ? 'border-blue-400 dark:border-blue-900 text-blue-900 dark:text-blue-300 bg-blue-50 dark:bg-blue-900/50 focus:text-blue-900 dark:focus:text-blue-200 focus:bg-blue-100 dark:focus:bg-blue-900 focus:border-blue-900 dark:focus:border-blue-300'
